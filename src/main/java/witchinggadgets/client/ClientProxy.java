...
public class ClientProxy extends CommonProxy
{
	...
	public void registerRenders()
	{
		...
		ClientRegistry.bindTileEntitySpecialRenderer(TileEntityMirrorPortal.class, new TileRenderMirrorPortal());
		ClientRegistry.bindTileEntitySpecialRenderer(TileEntitySpinningWheel.class, new TileRenderSpinningWheel());
		ClientRegistry.bindTileEntitySpecialRenderer(TileEntityLoom.class, new TileRenderLoom());
