...
public class WGConfig
{
	...
	public static boolean allowFocusPouchActive;
	...
	public static void loadConfig(FMLPreInitializationEvent event)
	{
		...
		allowFocusPouchActive = config.get("Other Options", "Allow FocusPouch active ability", true, "Dis-/enable the IActiveAbiltiy on the FocusPouch. With this enabled, TGs active ability menu will allow you to open the pouch.").getBoolean(true);
